...
# BE Careful the argument order of function for odeint and solve_ivp matters 
# https://stackoverflow.com/questions/56089651/not-subscriptable-problem-python-ode-solve
def dc_dt_ivp(
    t,
    c,
    x,
...
def rd_solve(
    ...
    #c = solve_ivp(fun=dc_dt_ivp, t_span=(t[0], t[-1]), y0 = c0, method='BDF',
    #              args = params,)  
