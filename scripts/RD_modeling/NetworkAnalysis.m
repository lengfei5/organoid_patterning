...
%__________________________________________________________________________
evaluate_diffusion = 1; %Set to 1 if Jacobian should be evaluated with diffusion. If set to 0 only the Jacobian excluding diffusion will be evaluated and no Turing instabilities will be analysed.
%__________________________________________________________________________
...
for i = 1:length(k_grid(1,:))
    ...
    %Distinguish damped oscillator from oscillator using the ODE
    %trajectories
    if max_min_count > 0
...
%__________________________________________________________________________
%Workflow Part 2: Given all steady states that are either stable or damped 
